...
export const AboutBroadsides = () => {
  return (
    <Page title="About Scottish Broadsides">
      ...
      <p>
        In the following data comic, see the life of the Broadsides from 1650 to
        1910. See how Broadsides' topics changed from official notices and royal
        proclamations, ballads, stories of execution and murder, to
        sensationalized novels. Finally, Broadsides evolved into our current
        newspaper.
      </p>
      ...
      <Stack direction={{xs:"column", md:"row"}} spacing={2} marginTop={4}>
        <div>
